...
export function Services() {
    return (
        <section className="bg-white text-gray-950 flex flex-col items-center px-3 pt-10">
            <div>
                <div className='flex gap-3'>
                    < ChevronRight className='bg-linear-to-r from-[#00BBFF] via-[#0077C9] to-[#000080] rounded-4xl p-2 w-10 h-8 text-white' /> 
                    <h2 className='text-2xl font-bold text-gray-950'>Fique tranquilo, podemos te auxiliar na:</h2>    
                </div>

                <div className='flex flex-col gap-4'>
                    <div className='flex flex-col gap-2 border-b-2 border-r-2 border-gray-200 rounded-2xl shadow-[10px_10px_10px_-5px_rgba(0,0,0,0.2)] p-6 bg-white'>
                    ...
                    <div className='flex flex-col gap-2 border-b-2 border-r-2 border-blue-800 rounded-2xl shadow-[10px_10px_10px_-5px_rgba(0,0,0,0.2)] p-6 bg-linear-to-r from-[#00BBFF] via-[#0077C9] to-[#000080] *:text-white'>
